...
//                    mMargin = (int) typedArray.getDimension(attr , defaultMargin);
                    mMargin = resolutionUtil.px2dp2pxWidth(-30);
                    break ;
    ...
    private void initIndicator() {
        ...
        //不用怕，这里做了处理不会变形的
        mIndicatorSize = Math.min(mIndicator.getIntrinsicWidth(),mIndicator.getIntrinsicHeight()) ;
//        mIndicatorSize = Math.max(mIndicator.getIntrinsicWidth(),mIndicator.getIntrinsicHeight()) ;
        /*设置指示器的边框*/
        mIndicator.setBounds(0,0,resolutionUtil.px2dp2pxWidth(32),resolutionUtil.px2dp2pxWidth(58));
...
//            canvas.restore();
    ...
    public void setViewPager(ViewPager viewPager){
        ...
        mCount = pagerAdapter.getCount()/10000 ;
//        mCount =  pagerAdapter.
...
//            Log.d("zgy","========"+position+",===offset" + positionOffset) ;
    ...
    public void onPageSelected(int position) {
        ...
        position = position % mCount;
        mSelectItem = position ;
//        Log.d("onPageSelected","~~~~~~~~~~"+position+"~~~~~~~~"+mSelectItem);
        if(mPageChangeListener != null){
